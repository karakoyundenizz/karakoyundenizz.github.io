  ...
  sections: [
    ...
    // projeler, sistem işleri ve okul
    {
      ...
      items: [
        ...
        {
          id: "crossroad",
          title: "Crossroad — a monitor for a shared intersection",
          node: "Crossroad",
          subtitle: "C++ · pthreads · monitors & condition variables",
          icon: "crossroad",
          summary: "An intersection where every car is a thread — no collisions, no deadlock, and nobody waits forever.",
          stats: [
            { value: "100 / 100", label: "grader score" },
            { value: "0", label: "violations, deadlocks, races" },
          ],
          bullets: [
          ...
          tags: ["C++", "pthreads", "Monitors", "Condition variables", "Deadlock freedom"],
          links: [
            { label: "Code on GitHub", href: "https://github.com/karakoyundenizz/CENG334---Operating-Systems/tree/main/Hw2", kind: "github" },
          ],
          media: [
            { src: "assets/img/crossroad-grader.webp", alt: "Grader output on my run: no synchronization violations and no deadlocks — every thread completed its exact route", w: 1100, h: 358, wide: true },
          ],
          note: "the whole thing is one Monitor subclass. the lock discipline is impossible to get wrong.",
        },
        {
          id: "ext2merge",
          title: "mergeext2fs — merging filesystems by hand",
          node: "ext2 merge",
          subtitle: "C++ · ext2 on-disk format · raw block I/O",
          icon: "db",
          summary: "git merge, one layer down: three ext2 disk images folded into one with nothing but open, read, write and lseek.",
          stats: [
            { value: "100 / 100", label: "all five cases" },
            { value: "~1.3k", label: "lines of C++" },
          ],
          bullets: [
          ...
          tags: ["C++", "Filesystems", "ext2", "Systems programming", "Bit manipulation"],
          links: [
            { label: "Code on GitHub", href: "https://github.com/karakoyundenizz/CENG334---Operating-Systems/tree/main/Hw3", kind: "github" },
          ],
          media: [
            { src: "assets/img/ext2-grader.webp", alt: "The official grader's final report: every test case 100.00, final grade 100.00 / 100.00", w: 1000, h: 744 },
          ],
          note: "the most fun I've had with a hex dump.",
        },
        {
          id: "networks",
          title: "Simulating and Reading Networks",
          node: "Networks",
          subtitle: "OMNeT++ / INET · Wireshark · CENG435",
          icon: "flow",
          summary: "Three assignments: measure a network, read a network, address a network.",
          bullets: [
          ...
          tags: ["OMNeT++", "INET", "Wireshark", "TCP/IP", "Routing", "Network forensics"],
          links: [
            { label: "Code on GitHub", href: "https://github.com/karakoyundenizz/CENG435---Data-Communications-and-Networking", kind: "github" },
          ],
          media: [
            { src: "assets/img/net-wireshark.webp", alt: "Wireshark filtered on the attacker's IP: a run of GET /login/root/... password guesses, then the GET for alice's receipt.xlsx", w: 1200, h: 496, wide: true },
            { src: "assets/img/net-saturation.webp", alt: "Throughput against interarrival time on a log scale — flat at about 95.4 Mbps once the interarrival time drops below 0.1 ms", w: 1100, h: 733, wide: true },
          ],
          note: "the wireshark shot is the actual capture. you can read the break-in off the Info column.",
        },
        {
          id: "y86",
        ...
        },
        {
          ...
          icon: "chip",
          summary: "Bare-metal microcontroller work: a Flappy Bird game on an LED matrix, a timer-free round-robin scheduler, and a serial link for an EV charging cabinet.",
          bullets: [
          ...
          tags: ["PIC18", "Assembly", "C", "Interrupts", "EUSART", "ADC", "Embedded"],
          links: [
            { label: "Flappy Bird (THE2)", href: "https://github.com/karakoyundenizz/CENG336---Embedded-Systems-Development/tree/main/THE2", kind: "github" },
            { label: "Round robin (THE1)", href: "https://github.com/karakoyundenizz/CENG336---Embedded-Systems-Development/tree/main/THE1", kind: "github" },
            { label: "EV cabinet (THE3)", href: "https://github.com/karakoyundenizz/CENG336---Embedded-Systems-Development/tree/main/THE3", kind: "github" },
          ],
          media: [
        ...
        },
        {
          ...
          links: [
            { label: "The architecture (74pp PDF)", href: "https://github.com/karakoyundenizz/CENG350---Software-Engineering/blob/main/PROJECT%20DOCUMENT/Project.pdf", kind: "github" },
            { label: "The requirements (68pp PDF)", href: "https://github.com/karakoyundenizz/CENG350---Software-Engineering/blob/main/PROJECT%20DOCUMENT/SRS.pdf", kind: "github" },
          ],
          media: [
      ...
      items: [
        ...
        },
        {
          ...
          tags: [
            ...
            { label: "Multithreading & sync", section: "projects", item: "crossroad" },
            { label: "Filesystem internals", section: "projects", item: "ext2merge" },
            ...
            { label: "Networking & protocols", section: "projects", item: "networks" },
        ...
        },
        {
          ...
          bullets: [],
          tags: ["Git", "GDB", "GoogleTest / GMock", "xUnit", "Jest / Maestro", "Valgrind", "clang-tidy", "Docker", "CI (GitHub Actions / GitLab)", "Wireshark", "OMNeT++", "MATLAB"],
          links: [],
        },
      ],
    },
